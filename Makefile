...
nyc/bikeSharingNYC.out: nyc/bikeSharingNYC.c lib/frontLib.o adt/stationsADT.o
	@$(COMPILER) $(DEBUGFLAGS) nyc/bikeSharingNYC.c lib/frontLib.o adt/stationsADT.o -o $(NYC_OUTPUT_FILE)
